...
const prototypePlaces = ["Tulsa", "Dallas", "Atlanta", "Chicago", "Los Angeles", "New York", "Miami", "Mexico City", "São Paulo", "London", "Nairobi", "Cape Town", "Lagos", "Mumbai", "Tokyo", "Sydney", "Manila"];
